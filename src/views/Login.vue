<template>
  <div
    class="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-100 via-blue-100 to-green-200 relative overflow-hidden"
  >
    ...
    >
      <svg
        ...
        viewBox="0 0 48 48"
        fill="currentColor"
        class="w-96 h-96 text-green-600"
      >
        <path
    ...
    <!-- card login -->
    <div
      class="relative bg-white/90 backdrop-blur p-8 m-4 rounded-2xl shadow-2xl max-w-sm w-full border border-green-200"
    >
      <h2 class="text-3xl font-bold text-center text-green-700 mb-8">♻️ Recycle Management</h2>
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-3 mt-2 border text-black border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400"
            required
          />
        </div>
